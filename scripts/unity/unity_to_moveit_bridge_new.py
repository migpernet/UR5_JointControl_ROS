...
def joint_cb(msg):
    rospy.loginfo("unity_to_moveit_bridge_new: received JointState with %d joints", len(msg.name))
...
if __name__ == "__main__":
    ...
    rospy.init_node("unity_to_moveit_bridge_new", anonymous=True)
    ...
    # Subscribe
    rospy.Subscriber("/ur5/goal_pose", JointState, joint_cb)

    rospy.loginfo("unity_to_moveit_bridge_new node started, listening to /ur5/goal_pose")
    rospy.spin()
